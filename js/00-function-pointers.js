...
// forEach(names, function(item) { console.log('Hi', item) })
...
// runThisFunc(() => { console.log('Hi') })

// runThisFunc(function() { return confirm('Are you sure') })
// runThisFunc(() => confirm('Are you sure'))

// One parameter - no need for (parenthesis)

// runThisFunc((name) => { console.log('Hi', name) })
// runThisFunc(name => console.log('Hi', name))

// runThisFunc(function(name1, name2) { console.log('Hi', name1, 'Dash from', name2) })
// runThisFunc((name1, name2) => console.log('Hi', name1, 'Dash from', name2))
...
//     confirm(`Hi ${name1}, do you know ${name2}?`)
